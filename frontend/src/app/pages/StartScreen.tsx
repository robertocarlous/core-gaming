    ...
    <BackgroundImg>
      <div className=" flex flex-col space-y-12 items-center justify-center">
        <div className="flex flex-col relative mt-[100px] ml-[25px]">
          ...
          />
          <span className="loading-text font-spline text-[17px] leading-[14.4px] z-40 absolute top-[73%] left-[39%]">
            loading
          </span>
        </div>
        <div
      ...
      "
        ...
        <div className="text-white font-bold items-center justify-center space-x-2 z-40 ml-9 flex bottom-2">
